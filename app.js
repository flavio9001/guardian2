      ...
      <div class="org-tree">
        <div class="org-node root">
          ...
          <div class="node-info">
            ...
            <span>${escapeHtml(vip.role || 'CEO / Diretor')}</span>
            ${vip.whatsapp ? `<small>📱 ${vip.whatsapp}</small>` : ''}
          </div>
        </div>
...
document.addEventListener('DOMContentLoaded', init);// ... (todo o código anterior mantido - login, api, etc.) ...
